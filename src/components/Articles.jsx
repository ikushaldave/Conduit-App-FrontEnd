...
function Articles () {
  return (
		<div className="flex justify-between items-center bg-gray-50 shadow-lg p-4 rounded-xl">
			...
			<div className="p-4">
				<h3 className="text-xl text-gray-700 font-extrabold my-1">
					<Link to="/">Github1s - Instantly Browse Projects on VSCode in Your Browser ⚡</Link>
				</h3>
				<div className="flex justify-between items-center my-2">
					<a href="##" className="capitalize">
						...
						<span className="align-bottom text-gray-700">Kushal Dave</span>
					</a>
				...
				<p className="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos pariatur, at tempora ad nam aliquam laboriosam minus quia?</p>
				<div className="text-right">
					<a href="##" className="text-indigo-500 capitalize">
						read more
					</a>
				</div>
			</div>
